$('.spanClose').click(function() {
  $('.indexadBox').css('top',' -85px');
  $('.indexHeader').css('marginTop','0px')
  $('.spanClose').css('display','none')
})
$('.indexadBox').css('top','0px')
$('.indexHeader').css('marginTop','85px')
...
// 课程轮播达人课程
var newswiper = new Swiper('.roombox .room1_1 .swiper-container', {
    slidesPerView: 4,
    spaceBetween: 15,
    slidesPerGroup: 4,
    loop: true,
...
$('.newslider1').each(function (i, e) {
    $(e).click(function () {
        $('.newslider1').removeClass('newslideractive');
        $(e).addClass('newslideractive');
        $('.newcontentright1').css('display', 'none');
        $('.newcontentright1').eq(i).css('display', 'block');
    });
});
...
$('.fkfkslider').each(function (i, e) {
  $(e).click(function () {
      ...
      $('.fkfk2con').eq(i).css('height', '120px');
  });
});
